...
export const TRIPS: Record<TripName, Trip> = {
  [TripName.Cervinia]: {
    ...
    location: "Italië",
    description: "Een onvergetelijke ski-ervaring op extreme hoogte met absolute sneeuwzekerheid. Perfect voor de ervaren ski-familie die op zoek is naar avontuur en unieke activiteiten.",
    pros: [
      "Ski-in/Ski-out op 2550m",
      "Extreem sneeuwzeker tot na Pasen",
      "Unieke kinderactiviteiten (pistebully, sneeuwscooter)",
      "Wellness met jacuzzi en sauna"
    ],
    imageUrl: "https://picsum.photos/seed/cervinia/800/600",
    idealFor: "Gezinnen met kinderen met ski-ervaring (vanaf niveau 3) die een groot, hooggelegen en veelzijdig skigebied zoeken."
  },
  [TripName.Nassfeld]: {
    id: TripName.Nassfeld,
    name: "Nassfeld",
    location: "Oostenrijk",
    description: "De ultieme gezinsbestemming waar comfort, gemak en plezier centraal staan. Met luxe appartementen direct aan de piste en een 'Parents Day' om zelf volop te genieten.",
    pros: [
    ...
    idealFor: "Gezinnen met skiërs van alle niveaus (ook beginners) die een compact, kindvriendelijk en comfortabel gebied wensen."
  },
  [TripName.LittleKidsWeek]: {
    id: TripName.LittleKidsWeek,
    name: "Little Kids Week (Nassfeld)",
    location: "Oostenrijk",
    description: "De perfecte, zorgeloze start voor de allerkleinsten. In een rustige periode, met skilessen vanaf 3 jaar en Nederlandstalige opvang, is dit de ideale eerste ski-ervaring.",
    pros: [
    ...
    idealFor: "Gezinnen met zeer jonge kinderen (peuters en kleuters) die in een veilige en rustige omgeving willen leren skiën."
  }
};
...
export const STATEMENTS: Statement[] = [
  {
    ...
    associatedTrips: [{ trip: TripName.LittleKidsWeek, weight: 3 }, { trip: TripName.Nassfeld, weight: 1.5 }]
  },
  {
    id: 'q2',
  ...
  },
  {
    ...
    associatedTrips: [{ trip: TripName.Cervinia, weight: 2.5 }, { trip: TripName.Nassfeld, weight: 1 }]
  },
  {
    id: 'q4',
    text: "We houden van de uitgestrekte natuur en prima skiaccomadatie.",
  ...
  },
  {
    ...
    associatedTrips: [{ trip: TripName.Nassfeld, weight: 2.5 }, { trip: TripName.LittleKidsWeek, weight: 1.5 }]
  },
  {
    id: 'q6',
